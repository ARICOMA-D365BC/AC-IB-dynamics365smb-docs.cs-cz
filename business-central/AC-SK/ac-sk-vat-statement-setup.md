...
Pro zajištění správné kalkulace částek Výkazu DPH a exportu do požadované struktury XML, je potřeba nastavit několik níže uvedených oblastí.
...
V Nastavení financí je možné aktivovat systémové kontroly při účtování těchto komodit.
